...
import resumePDF from "../../public/JohnFinleyResume.pdf";

export default function Home() {
  const [resumeButtonOptions, setResumeButtonOptions] = useState(false);
  ...
  const downloadPDF = () => {
    fetch(resumePDF).then((response) => {
      response.blob().then((blob) => {
        ...
        alink.href = fileURL;
        alink.download = "JohnFinleyResume.pdf";
        alink.click();
      });
    });
  };
        ...
        <div id="details-container">
          ...
          <div id="resume-button-container">
            <button
              id="resume-button"
              onClick={() => {
                setResumeButtonOptions((current) => !current);
              }}
            >
              Resume{" "}
              <svg
          ...
          <div id="mobile-resume-button-container">
            <button id="mobile-resume-button" onClick={downloadPDF}>
              Resume{" "}
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <div id="mobile-socials">
              ...
              <Link to="https://www.linkedin.com/in/john-tyler-finley/" target="_blank">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
